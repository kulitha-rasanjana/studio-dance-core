...
const PersonProfileCard = ({ name, roles, imageUrl, instagramUrl, facebookUrl, tiktokUrl, youtubeUrl }) => {
  return (
    <>
      <div className="flex flex-col items-center p-6 sm:p-8 md:p-10 md:flex-row md:items-center md:justify-center md:space-x-8 lg:space-x-16 bg-gray-100 rounded-xl shadow-lg transition-transform duration-300 ease-in-out hover:scale-105">
        ...
        <div className="p-6 sm:p-8 w-full max-w-sm sm:max-w-md md:max-w-lg text-gray-800">
          <h2 className="font-sans text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 leading-tight">
            {name}
          </h2>
