  ...
  <>
    ...
    >
      ...
      >
        ...
        <div className="py-4 sm:py-5 text-center bg-black opacity-80"> {/* Added bg-opacity to make text readable over background */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl tracking-widest md:text-6xl lg:text-7xl" style={{ fontFamily: "'MetroPhotograph - Demo Version Regular'", letterSpacing: '0.1em', color: '#ffffffff', fontWeight: 'bold' }}>
            DANCE CORE HIGHER FAMILY
          </h1>
        </div>

        <div className="py-8 sm:py-10 space-y-12 sm:space-y-16 md:space-y-20 bg-opacity-90"> {/* Added bg-opacity to make text readable over background */}
